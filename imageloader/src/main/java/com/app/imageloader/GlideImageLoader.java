...
import com.app.imageloader.progress.OnGlideImageViewListener;
import com.app.imageloader.progress.OnProgressListener;
import com.app.imageloader.progress.ProgressManager;
import com.app.imageloader.transformation.GlideCircleTransformation;
        ...
        return Glide.with(getContext())
                ...
                .listener(new RequestListener<Drawable>() {
                    ...
                    public boolean onLoadFailed(@Nullable
                                                        GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {

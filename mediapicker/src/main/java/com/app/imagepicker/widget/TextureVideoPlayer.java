...
public class TextureVideoPlayer extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public void play() {
        LogUtil.i("aaa", "urlurlurl:" + url);
        LogUtil.i("aaa", "mMediaPlayer:" + mMediaPlayer);
        if (mMediaPlayer == null) return;

        try {
            LogUtil.i("aaa", "mMediaPlayerurlurlurl:" + url);
            mMediaPlayer.reset();
    ...
    public void setOnSeekCompleteListener(MediaPlayer.OnSeekCompleteListener onSeekCompletionListener) {
        if (mMediaPlayer != null) {
    ...
    private Handler mProgressHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                if (listener != null && mMediaPlayer != null && mState == VideoState.palying) {

...
import com.app.imagepicker.widget.scaleview.decoder.CompatDecoderFactory;
import com.app.imagepicker.widget.scaleview.decoder.DecoderFactory;
import com.app.imagepicker.widget.scaleview.decoder.ImageDecoder;
import com.app.imagepicker.widget.scaleview.decoder.ImageRegionDecoder;
import com.app.imagepicker.widget.scaleview.decoder.SkiaImageDecoder;
import com.app.imagepicker.widget.scaleview.decoder.SkiaImageRegionDecoder;
...
public class SubsamplingScaleImageView extends View {
    ...
    public final void setImage(ImageSource imageSource, ImageSource previewSource,
                               ImageViewState state) {
        LogUtil.d(TAG, "setImage" + "uri:" + imageSource.getUri().toString() + "id"
    ...
    private void execute(AsyncTask<Void, Void, ?> asyncTask) {
        if (parallelLoadingEnabled && Build.VERSION.SDK_INT >= 11) {
            try {
                ...
                LogUtil.i(TAG, "Failed to execute AsyncTask on thread pool executor, falling back to single threaded executor" + e);
            }
        }
        asyncTask.execute();
    }
